!function($) {
  ...
  Dragging.prototype.move = function(e) {
    ...
    deltaX = (e.changedTouches ? e.changedTouches[0].pageX : e.pageX) - this.origin.x;
    deltaY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.origin.y;
  ...
  Draggable.prototype.start = function(e) {
    ...
    if (this.opts.handle) {
      target = $(e.target), isHandle = false;
      while (target[0] !== this.el[0]) {
